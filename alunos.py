...
def add():
    ...
    if request.method=="POST":
        ...
        if not t or t <0 or t > 10: erros.append("Trabalho é um campo obrigatório ou os valores não entre 0-10")
        if not p1 or p1 <0 or p1 > 10: erros.append("Prova 1 é um campo obrigatório ou valores não entre 0-10")
        if not p2 or p2 <0 or p2 > 10: erros.append("Prova 2 é um campo obrigatório ou valores não estre 0-10")
        ...
        if len(erros) == 0:
             ...
             id = last_id+1
             alunos[id] = {"nome" : nome, "usuario": usuario, "t": t, "p1":p1, "p2": p2}
